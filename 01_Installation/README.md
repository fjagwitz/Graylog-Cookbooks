...
Get it from here:
    ...
    curl -sO https://raw.githubusercontent.com/fjagwitz/Graylog-Cookbooks/refs/heads/Graylog-7.1/01_Installation/install-graylog.sh && chmod +x install-graylog.sh && ./install-graylog.sh
